...
namespace MyProject1
{
    ...
    public class inheritance
    {
        public static void Main()
        {
            ...
            Person p = new Person() { id = 1, name = "Sukku", age = 19 };
            Man m = new Man() { id = 1, name = "Karthik", age = 20, playing = "footbal" };
            Woman w = new Woman() { id = 1, name = "Sukrutha", age = 21, PlayingManage = "footbal and home" };
